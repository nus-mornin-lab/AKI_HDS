...
with tf.Session() as sess:
    ...
    print("Micro AUC is ", roc_auc_score(y, predicts, average='micro'))
    print("Macro AUC is ", roc_auc_score(y, predicts, average='macro'))
    print("Weighted AUC is ", roc_auc_score(y, predicts, average='weighted'))
